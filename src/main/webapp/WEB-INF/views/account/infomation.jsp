        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><c:if test="${account.nickname == null}">
                            <span >Hi,美食家</span>
                        </c:if>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td class="attributeList">
                                            <input id="nickname" type="text" value="${account.nickname}">
                                        </td>
                                        <td>
                                            <a id="aNick" >修改</a>
                                        </td>
                                    ...
                                    <tr>
                                        <c:if test="${account.username == null}">
                                            ...
                                            <td class="attributeList">
                                                <input id="username" type="text" placeholder="3-20，字母数字和“_”，字母开头，仅能修改一次"/>
                                            </td>
                                            <td>
                                                <a id="aUser">修改</a>
                                            </td>
