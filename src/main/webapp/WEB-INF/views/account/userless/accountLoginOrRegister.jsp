                        ...
                        <div class="content">
                            ...
                            <div class="form loginBox">
                                ...
                                <form method="post" accept-charset="UTF-8">
                                    <input id="username" class="form-control" type="text" placeholder="手机/用户名/邮箱" name="username">
                                    <input id="loginPassword" class="form-control" type="password" placeholder="密码" name="password">
                                    <input id="loginButton" class="btn btn-default btn-login" type="button" value="登陆">
                                </form>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="content registerBox" style="display:none;">
                            <div class="form">
                                ...
                                <form method="post" action="<c:url value="/account/accountRegister"/>" accept-charset="UTF-8">
                                    ...
                                    <input id="registerButton" class="btn btn-default btn-register" type="submit" value="注册" >
                                </form>
                            </div>
                        </div>
                    </div>
