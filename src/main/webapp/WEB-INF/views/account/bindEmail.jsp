...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/account/bindEmail.js" type="text/javascript"></script>
</head>
<body>
    <!-- 导航条 -->
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="bindDiv">
                            <table width="800">
                                ...
                                <td width="180" id="showSpan1">验证邮箱号码</td>
                                <td width="130">
                                ...
                                <td width="180" id="showSpan2">绑定新邮箱号码</td>
                                <td width="130">
                                    <span class="spanShow"></span>
                                </td>
                                <td width="50">
                            ...
                            <div class="bindTable">
                                <table width="500" >
                                    ...
                                    <tr width="500px" height="60px">
                                        <td>
                                            <input id="currentEmail" type="text" readonly value="当前的邮箱">
                                        </td>
                                        <td>
                                    ...
                                    <tr width="500px" height="60px">
                                        <td>
                                            <input id="getCode" type="text" readonly value="获取验证码">
                                        </td>
