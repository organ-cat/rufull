...
<head>
    ...
    <script type="text/javascript">
        ...
        function submitform() {
            ...
            var password2 = "${maccount.password}";
...
<form id="ManagerForm" name="accountInfoform" class="form-inline"
    ...
    <div class="col-sm-8" style="padding-top: 20px;padding-left: 200px">
        <div class="form-group">
            <label style="font-size: 20px;" for="password">用户密码:</label>
            <input type="text" class="form-control input-lg" style="min-width: 450px;" id="password" required
    ...
    <div class="col-sm-8" style="padding-top: 20px;padding-left: 200px">
        <div class="form-group">
            <label style="font-size: 20px;" for="email">用户邮箱:</label>
            <input type="email" class="form-control input-lg" style="min-width: 450px;" id="email" required
