...
<div class="container cart">
		...
		<div class="span24">
			...
			<form id="orderForm" action="${pageContext.request.contextPath }/user/orderPay.action" method="post">
					...
					<p>
						...
						<p style="text-align:right">
							<a href="javascript:document.getElementById('orderForm').submit();">
								<img src="${pageContext.request.contextPath}/bank_img/finalbutton.gif" width="204" height="51" border="0" />
							</a>
						</p>
				</div>
			</form>
