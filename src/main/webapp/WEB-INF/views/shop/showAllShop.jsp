...
<div role="main">
    <div class="container clearfix">
        ...
        <div class="place-search" role="search"><label
            ...
            <img src="${pageContext.request.contextPath}/image/service/search.png" style="width:15px;height:15px;margin-right:20px"/></a>
            <div class="searchbox">
                ...
                <c:forEach var="shop" items="${requestScope.shopList}">
                    <a href="${pageContext.request.contextPath}/shop/showShopDetail?id=${shop.id}"   data-bidding="" target="_blank" class="rstblock">
                        <div class="rstblock-logo"><img
                                src="${pageContext.request.contextPath}/upload/shop/${shop.shopPhoto}"
                                width="70" height="70" alt="${shop.shopName}" class="rstblock-logo-icon"><span
                                class="rstblock-left-timeout">${shop.shippingTime}+ 分钟</span></div>
                        <div class="rstblock-content">
                            ...
                            <div class="rstblock-cost">
                                <c:choose>
                                    <c:when test="0 == ${shop.shippingFee}">
                                        免费配送
                                    </c:when>
                                    <c:otherwise>
                                        ￥ ${shop.shippingFee}
                ...
                <%--<a href=" "   data-bidding="" target="_blank"--%>
                   <%--class="rstblock-closed rstblock">--%>
                    ...
                    <%--<div class="rstblock-content">--%>
                        ...
                        <%--&lt;%&ndash;<div class="rstblock-relaxing">商家休息,暂不接单</div>&ndash;%&gt;--%>
                    <%--</div>--%>
                <%--</a>--%>
