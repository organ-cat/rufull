                ...
                <div class="col-md-2">
                    <ul class="list-group text-center">
                        ...
                        <c:if test="${shop != null}">
                            ...
                            <li class="list-group-item list-group-item-info"><a class="text-muted" href="${pageContext.request.contextPath}/business/showOrder?shopId=${sessionScope.shop.id}&orderStatus=AUDITING">退单记录</a></li>
